getImplications <- function(){
  implications <- list(c("budget","community_vote","community_count","critics_vote"),
                       ...
                       c("community_vote","genre","critics_count","community_count"),
                       c("community_vote","genre","critics_vote","community_count"),
                       c("community_vote","major","us","genre","budget"),
                       c("community_vote","major","critics_count","community_count"),
